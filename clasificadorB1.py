...
autoencoder_checkpoint_path70 = r'C:\Users\tian_\Desktop\lightning_logs\unet_autoencoderB1-70.pth'
autoencoder_checkpoint_path90 = r'C:\Users\tian_\Desktop\lightning_logs\unet_autoencoderB1-90.pth'
...
class AutoencoderVGG16(pl.LightningModule):
    def __init__(self, data_dir, num_classes):
        super(AutoencoderVGG16, self).__init__()
        ...
        self.autoencoder.load_state_dict(torch.load(autoencoder_checkpoint_path90))
        
        # Congelar parámetros del autoencoder
